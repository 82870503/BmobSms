...
public class RegistActivity extends Activity implements View.OnClickListener {
    ...
    private void initBomb() {
        BmobSMS.initialize(RegistActivity.this, "d6179a5e8d4ad231c5389b460b4f9f7b");
                    ...
                    BmobSMS.requestSMSCode(this, userName, "短信模板", new RequestSMSCodeListener() {
                        ...
                        public void done(Integer integer, BmobException e) {
                            if (e == null) {
                                ...
                                Toast.makeText(RegistActivity.this, "验证码发送成功，请尽快使用", Toast.LENGTH_SHORT).show();
                                /**
                                 * 倒计时1分钟操作
                                 * 说明：
                                ...
                                Toast.makeText(RegistActivity.this, "验证码发送失败，请检查网络连接", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }
